...
*/
   ...
   //     SmartDashboard.putNumber("Chassis PID setpoint",getController().getSetpoint()) ;
  //      SmartDashboard.putNumber("Chassis PID position error",getController().getPositionError()) ;
     ...
     //   SmartDashboard.putBoolean("PID Enable ", getController().isContinuousInputEnabled());
